		...
		<table class="table table-bordered">
			<thead>
				<tr>
					...
					<th class="cart-product-name item" style="padding-right: 180px;">Product Name</th>
				...
				<tr>
					...
					<td class="cart-image">
						<a class="entry-thumbnail" href="detail.html">
						    <!--<img src="admin/product_images/<?php// echo $row['id'];?>/<?php //echo $row['image'];?>" alt="" width="114" height="146">-->
						    <img src="admin/product_images/<?php echo $row['image'];?>" alt="" width="50" height="108">
						</a>
					</td>
