    <footer id="footer" class="footer color-bg" style="padding-top: 30px;">
            ...
            <ul class="toggle-footer" style="">
              <li class="media">
                ...
                <div class="media-body">
                  <p>Iqra University Gulshan Campus</p>
                </div>
              </li>
              <li class="media">
              ...
              <li class="media">
                ...
                <div class="media-body outer-top-xsm"> <span><a href="mailto:smsadiq1995@gmail.com">Comfortmart.com</a></span> </div>
              </li>
            </ul>
          </address>
                        <!-- /.module-body -->
                    ...
                    <div class="col-sm-3">
                        ...
                        <div class="module-body">
                            <ul class='list-unstyled'>
                                ...
                                <li><a href="#" title="Popular Searches">Location</a></li>
                                <li class="last"><a href="#" title="Where is my order?">Term & Condition</a></li>
                            </ul>
                        </div>
                        <!-- /.module-body -->
                    </div>
        ...
        <div class="copyright-bar">
            <div class="container">
                ...
                <div class="col-md-4 no-padding social" style="text-align: center;">
                   ...
                   <br><br>
                   <p style="color: white; font-size:1vw;" class="text-center">© ComfortMart.com 2019. All Rights Reserved</p>
                </div>
                <div class="col-md-4"></div>
            </div>
        </div>
