...
$query=mysqli_query($conn,"INSERT into ordertrackhistory(orderId,status,remark) values('$oid','$status','$remark')");
$sql=mysqli_query($conn,"UPDATE orders set orderStatus='$status' where id='$oid'");
...
$st='Delivered';
   ...
   <br>
    ...
    <tr>
      ...
      <td  class="fontkink"> <input type="submit" name="submit" id="submit" class="btn btn-success"  value="update"   size="40" style="cursor: pointer;" /> &nbsp;&nbsp;  </td>  
           </tr> 
