...
?>										
     ...
     <li><a href="view_order.php?oid=<?php echo $row['uid'];?>" data-toggle="modal" data-target="#theModal">View Order</a></li>
 </ul>
 ...
 <ul class="nav navbar-nav" id="menu">
     <li><a href="updateorder.php?oid=<?php echo $row['uid'];?>" data-toggle="modal" data-target="#theModal">Response</a></li>
 </ul>
  <div id="theModal" class="modal fade text-center">
    <div class="modal-dialog">
      <div class="modal-content">
