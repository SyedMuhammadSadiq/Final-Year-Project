...
if(isset($_POST['ProductSubmit'])) { 
          ...
          $query= "INSERT  INTO products(name,brands_id,price,description,categorys_id,stock,image) values('$productname','$brands_id','$productprice','$productdescription' ,'$categorys_id' , '$stock' ,'$productimage')";
...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input placeholder="Product Name" class="form-control input-md" name="name"   type="text">
...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input placeholder="Product Price" class="form-control input-md" name="price"  type="text">
...
<div class="form-group" >
  ...
  <div class="col-md-4">
    <input class="input-file" type="file" name="image"><br>
