...
$conn = mysqli_connect("localhost", "root", "", "userregister");
    ...
    //$get_product = "SELECT products.*,category.category_name,brands.brand_name from products join category on category.category_id=products.categorys_id join brands on brands.brand_id=products.brands_id where product_id='$get_id'";
	 ...
	 $get_category = "select * from category where category_id='$categorys_id'";
...
<div class="form-group" >
  ...
  <div class="col-md-4">
      <input class="input-file" type="file" name="product_image" value="product_image" ><img src="product_images/<?php echo $product_image; ?>" >  
  ...
  if (isset($_POST['updateProduct'])) {
      ...
      $update_id = $product_id;
        ...
        // $brands_id=$_POST['brands_id'];
          ...
          $update_product= "UPDATE products set product_name='$product_name' , brands_id ='$brands_id', product_price='$product_price', product_description='$product_description', categorys_id=' $categorys_id' , stock = '$stock' , product_image = '$product_image' where product_id='$update_id'";
